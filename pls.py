...
with aba2:
    ...
    df_pls = pd.DataFrame(list(colecao.find(query)))
    ...
    col3.button("Verificar atualizações", icon=":material/refresh:", use_container_width=True, on_click=dial_verificar_atualizacoes, type="primary", key="botao_abrir_dialogo")
